...
const customers = [
...

  {
    ...
    recipients: [
      { nama: "PT. Pitaco Mitra Perkasa", alamat: "Jl. Anggrek Neli Murni XI, Jakarta Barat" },
      { nama: "PT. Pitaco Mitra Perkasa", alamat: "Waduk Kampung Rambutan, Jakarta Timur" },
      { nama: "PT. Alko Putra Mahkota", alamat: "Jl. Raya Pd. Gede 015/001, Pinang Ranti, Jakarta Timur" },
      { nama: "PT. Leo Tunggal Mandiri", alamat: "Waduk Cimanggis 1 dan 2, Jakarta Timur" },
      { nama: "PT. Leo Tunggal Mandiri", alamat: "Jl. Raya PKP, Ciracas" },
      { nama: "PT. Alko Saudara Sejati", alamat: "Kawasan Kel. Balekambang, Jakarta Timur" },
      { nama: "PT. Alko Putra Mahkota", alamat: "PSU di Kel. Balekambang, Paket Pekerjaan Pagar Pengaman" },
      { nama: "PT. Cahaya Nusantara Berkarya", alamat: "Jl. Intan VI, Sumur Batu, Kec. Kemayoran, Jakarta Pusat" },
    ],
    prices: [
      ["B01", "BA", "PASIR BANGKA", 430000, 0, 0, "CD", "CD"],
      ["C01", "CC", "PASIR URUK", 240000, 0, 0, "CD", "CD"],
      ["P01", "PT", "PASIR PASANG CILEGON", 300000, 0, 0, "CD", "CD"],
      ["E01", "EE", "PASIR COR / KALIMANTAN", 350000, 0, 0, "CD", "CD"],
      ["P02", "PJ", "PASIR JAMBI", 330000, 0, 0, "CD", "CD"],
      ["B02", "BB", "BATU SPLIT", 475000, 0, 0, "CD", "CD"],
      ["D01", "DD", "BATU BELAH", 350000, 0, 0, "CD", "CD"],
      ["K01", "KK", "MAKADAM", 350000, 0, 0, "CD", "CD"],
      ["H01", "HH", "SIRDAM", 350000, 0, 0, "CD", "CD"],
      ["I01", "II", "ABU BATU", 385000, 0, 0, "CD", "CD"],
      ["G01", "GG", "BASECOSE B", 375000, 0, 0, "CD", "CD"],
      ["G02", "GG", "BASECOSE A", 450000, 0, 0, "CD", "CD"],
      ["F01", "FF", "SIRTU", 240000, 0, 0, "CD", "CD"],

      ["B01", "BA", "PASIR BANGKA", 420000, 0, 0, "TRONTON", "TRONTON"],
      ["C01", "CC", "PASIR URUK", 175000, 0, 0, "TRONTON", "TRONTON"],
      ["P01", "PT", "PASIR PASANG CILEGON", 275000, 0, 0, "TRONTON", "TRONTON"],
      ["E01", "EE", "PASIR COR / KALIMANTAN", 340000, 0, 0, "TRONTON", "TRONTON"],
      ["P02", "PJ", "PASIR JAMBI", 320000, 0, 0, "TRONTON", "TRONTON"],
      ["B02", "BB", "BATU SPLIT", 380000, 0, 0, "TRONTON", "TRONTON"],
      ["D01", "DD", "BATU BELAH", 280000, 0, 0, "TRONTON", "TRONTON"],
      ["K01", "KK", "MAKADAM", 270000, 0, 0, "TRONTON", "TRONTON"],
      ["H01", "HH", "SIRDAM", 300000, 0, 0, "TRONTON", "TRONTON"],
      ["I01", "II", "ABU BATU", 320000, 0, 0, "TRONTON", "TRONTON"],
      ["G01", "GG", "BASECOSE B", 380000, 0, 0, "TRONTON", "TRONTON"],
      ["G02", "GG", "BASECOSE A", 320000, 0, 0, "TRONTON", "TRONTON"],
      ["F01", "FF", "SIRTU", 175000, 0, 0, "TRONTON", "TRONTON"],
    ]
  },

  {
    ...
    divisi: DIVISI_CUSTOMER,
    recipients: [
      { nama: "CV. Areta Jaya", alamat: "Gg. Serbaguna Jl. Raya Gereja Tugu, Semper Barat" },
      { nama: "CV. Hotma Marojahan", alamat: "Rusunawa Penjaringan, Jl. Tanah Pasir, Jakarta Utara" },
      { nama: "CV. Hotma Marojahan", alamat: "Sinar Barokah, Jl. Kalibaru, Cilincing, Jakarta Utara" },
      { nama: "CV. Areta Jaya", alamat: "Jl. Sunter Kemayoran 013/002 No. 33, Sunter Jaya" },
      { nama: "PT. Harumas PM", alamat: "Gg. Elektro Pintu Masuk No. 6 006/017, Penjaringan" },
      { nama: "PT. Peatalun Jaya", alamat: "Jl. Bendungan Jago, Dalam Utan Panjang, Kemayoran" },
      { nama: "PT. Reza Berkah Abadi", alamat: "Jl. H. Amsir, Cipinang Melayu" },
      { nama: "PT. Tiara Sira Jaya", alamat: "Jl. Asri Halim Perdana Kusuma, Jakarta Timur" },
      { nama: "PT. Harumas PM", alamat: "Klinik Pratama, Jl. Inspeksi, Penjaringan" },
      { nama: "PT. Harumas PM", alamat: "Jl. Kertajaya Raya Gg. Marlina, Penjaringan" },
      { nama: "PT. Daliltani Pormesa", alamat: "Jl. Lodan Raya, Ancol" },
      { nama: "PT. Daliltani Pormesa", alamat: "Jl. Kampung Bandan Raya, Ancol" },
      { nama: "PT. Restu Bumantara", alamat: "Jl. Manunggal 2, Cipinang Melayu" },
    ],
    prices: [
      ["B01", "BA", "PASIR BANGKA", 430000, 0, 0, "CD", "CD"],
      ["C01", "CC", "PASIR URUK", 240000, 0, 0, "CD", "CD"],
...
async function upsertCustomer(item) {
  ...
  for (const [
    ...
    const normalizedVehicleType = String(vehicleType || "CD").toUpperCase();
    await prisma.customerPrice.upsert({
      where: {
        customerId_destinationCode_vehicleType_stockCode: {
      ...
      update: {
        stockName, hargaM3, sewaTruk, hppTruk, destination, vehicleType: normalizedVehicleType,
      },
      create: {
        customerId: customer.id, destinationCode, vehicleType: normalizedVehicleType, stockCode, stockName, hargaM3, sewaTruk, hppTruk, destination,
      },
    });
  }
  ...
  for (const r of item.recipients || []) {
    const existing = await prisma.customerRecipient.findFirst({
      where: { customerId: customer.id, nama: r.nama, alamat: r.alamat },
    });
    if (existing) {
